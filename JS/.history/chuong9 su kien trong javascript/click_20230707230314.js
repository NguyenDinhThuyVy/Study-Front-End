...
link.addEventListener("click", function (e) {
  e.preventDefault(); // ngăn chặn load lên web để hiện thị việc muốn làm
  // console.log("It's a website when I click on the link");
  ...
  // ******custom attribute data-yourName
  // event.target.dataset.yourName
  const name = e.target.dataset.nameZyzy;
  console.log(name);
});
